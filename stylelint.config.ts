...
export default {
  ...
  rules: {
    ...
    */
     ...
     * https://github.com/stylelint-scss/stylelint-scss/tree/300eb3d92a25229734d7165450db7512dc181dd0?tab=readme-ov-file#list-of-rules
     */
    /* @function名の命名ルールを制限しない */
    'scss/at-function-pattern': null,
    /* @mixin名の命名ルールを制限しない */
    'scss/at-mixin-pattern': null,
    /* 条件付き@ルール (@if trueなど) における括弧の使用を制限しない */
    'scss/at-rule-conditional-no-parentheses': null,
    /* 不明な@ルール宣言を許可（対Mixin） */
    'scss/at-rule-no-unknown': null,
    /* 空のコメントを許可 */
    'scss/comment-no-empty': null,
    /* 名前に"-"が含まれるプロパティのネスト指定を禁止 */
    'scss/declaration-nested-properties': 'never',
    /* ユニオンクラス名（&__element、&--modifierなど）の使用を禁止 */
    'scss/selector-no-union-class-name': true,
    /* @import、@use、@forward、[meta.load-css]の参照名の拡張子の有無を制限しない */
    'scss/load-partial-extension': null,
    /* @import、@use、@forwardの重複（同じファイルの重複呼び出し）を禁止 */
